var keyCap = '6LdkZWgUAAAAABuU_dUMsPkZjSJ0kANfIDdRsURh';
var pgSobre = `
						<div id="logo"></div>
				 ...
				 <form action="?" method="POST" id="frm">
					<div class="form-group">					
						<div class="input-group">
							...
							<input type="text" class="form-control input" placeholder="Digite seu nome completo" name="nome" id="nome">
						</div>
					</div>
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" class="form-control input" placeholder="Digite seu e-mail" name="email" id="email">
						</div>
					</div>
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" class="form-control input" placeholder="Digite seu assunto" name="assunto" id="assunto">
						</div>
					</div>
          
					<div class="form-group">
							<textarea class="form-control input" name="mensagen" id="mensagem" rows="4" cols="50"></textarea>
					</div>
